...
<body class="h-full bg-gray-100 flex flex-col items-center justify-center font-sans antialiased py-10">
    ...
    <div class="mb-6 text-center">
        ...
        <div class="text-xs text-gray-400 mt-1">Création du Super Admin</div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-8 w-full max-w-md">
        ...
        <h1 class="text-lg font-bold text-center text-gray-900 mb-1">Créer le Super Administrateur</h1>
        <p class="text-sm text-gray-500 text-center mb-6">
            Cette page n'est accessible qu'une seule fois. Une fois le compte créé, elle sera désactivée.
        </p>
        ...
        <form method="POST" action="{{ route('admin.register.post') }}">
            ...
            <div class="mb-4">
                <label class="block text-xs font-medium text-gray-600 mb-1.5">Mot de passe * (min. 10 caractères)</label>
            ...
            <div class="mb-6 bg-amber-50 border border-amber-200 text-amber-700 text-xs px-4 py-3 rounded-lg">
                ⚠ Ce formulaire ne peut être utilisé qu'une seule fois. Conservez vos identifiants en lieu sûr.
            </div>
