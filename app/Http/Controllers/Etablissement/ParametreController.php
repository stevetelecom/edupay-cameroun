...
class ParametreController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Erreur maj parametres (etab ' . $etablissement->id . ') : ' . $e->getMessage(), ['trace' => $e->getTraceAsString()]);

            return redirect()->route('etablissement.parametres.index')
                ->with('error', 'Impossible d\'enregistrer les paramètres. ' . $e->getMessage());
        }
    }
}
